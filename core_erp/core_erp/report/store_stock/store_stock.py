	...
	for (company, item, warehouse) in sorted(iwb_map):
		if item_map.get(item):
			...
			report_data = {
				...
				'item_code': item,
				'category': frappe.db.get_value("Item",item,"category"),
				'product_category': frappe.db.get_value("Item",item,"product_category"),
				'tarrif': frappe.db.get_value("Item",item,"gst_hsn_code"),
				'product_line': frappe.db.get_value("Item",item,"product_line"),
				'price_category': frappe.db.get_value("Item",item,"price_category"),
				'product_variant': frappe.db.get_value("Item",item,"product_variant"),
				'promo_code': frappe.db.get_value("Item",item,"promo_code"),
				'warehouse': warehouse,
				'company': company,
...
def get_columns(filters):
	...
	columns = [
		...
		{"label": _("Part No"), "fieldname": "item_code", "fieldtype": "Link", "options": "Item", "width": 100},
		{"label": _("Item Group"), "fieldname": "item_group", "fieldtype": "Link", "options": "Item Group", "width": 100},
		{"label": _("Category"), "fieldname": "category", "fieldtype": "Link", "options": "Category", "width": 100},
		...
		{"label": _("Tarrif"), "fieldname": "tarrif", "fieldtype": "Link", "options": "GST HSN Code", "width": 100},
		{"label": _("Product Line"), "fieldname": "product_line", "fieldtype": "Link", "options": "Product Line", "width": 100},
		{"label": _("Product Category"), "fieldname": "product_category", "fieldtype": "Link", "options": "Product Category", "width": 100},
		{"label": _("Price Category"), "fieldname": "price_category", "fieldtype": "Link", "options": "Price Category", "width": 100},
		{"label": _("Product Variant"), "fieldname": "product_variant", "fieldtype": "Link", "options": "Product Variant", "width": 100},
		{"label": _("Promo Code"), "fieldname": "promo_code", "fieldtype": "Link", "options": "Promo Code", "width": 100},
