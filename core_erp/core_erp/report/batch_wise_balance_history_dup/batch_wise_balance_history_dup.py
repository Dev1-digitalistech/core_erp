		...
		for wh in sorted(iwb_map[item]):
			for batch in sorted(iwb_map[item][wh]):
				...
				if qty_dict.opening_qty or qty_dict.in_qty or qty_dict.out_qty or qty_dict.bal_qty:
					data.append([item, item_map[item]["item_name"], item_map[item]["description"], wh, batch,qty_dict.vendor_batch_no,
...
def get_columns(filters):
	...
	[_("Warehouse") + ":Link/Warehouse:100"] + [_("Batch") + ":Link/Batch:100"] +[_("Vendor Batch No")+ "::100"]+ [_("Opening Qty") + ":Float:90"] + \
